		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[FI] 재무상태표",
									"targetURL": "#synccafifinancial-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccafifinancial-display": {
								"semanticObject": "synccafifinancial",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ca.fi.financial",
									"url": sap.ui.require.toUrl("sync/ca/fi/financial")
								}
							}
						}
					}
